...
exports.checkPlusSuccess = async (req, res, next) => {
  try {
    res.setHeader("X-Frame-Options", "ALLOWALL");
    ...
    if (/^0-9a-zA-Z+\/=/.test(sEncData) == true) {
      ...
      return res.render("checkplus_fail.ejs", {
        sRtnMSG,
        requestnumber,
        authtype,
        errcode,
...
exports.checkPlusFailure = async (req, res, next) => {
  try {
    res.setHeader("X-Frame-Options", "ALLOWALL");
    const sEncData = req.body.EncodeData;
    let cmd = "";
...
exports.getCheckPlusSuccess = async (req, res, next) => {
  try {
    res.setHeader("X-Frame-Options", "ALLOWALL");
...
exports.getCheckPlusFailure = async (req, res, next) => {
  try {
    res.setHeader("X-Frame-Options", "ALLOWALL");
    const sEncData = req.query.EncodeData;
    let cmd = "";
