...
const AppleToptenComponent = props => {
        ...
        <Content>
          <div className="wrapper_topten">
            <div className="text_group">
              ...
              {toptenList.length > 0 ? (
                <h2 className="contest_title">PUSH MY DREAM</h2>
              ) : (
                <h2 className="contest_title">2020 첫번째 PUSH MY DREAM</h2>
              )}
              {toptenList.length > 0 ? (
                <h3 className="rank">{`${toptenIdx + 1}위 ${
                  toptenList[toptenIdx].user_name
                }`}</h3>
              ) : (
            ...
            <div className="thumbnail_list_frame">
              ...
              <div className="thumbnail_active_frame" />
              <div className="thumbnail_list">
                {toptenList && toptenList.length > 0 ? (
                  toptenList.map(item => (
                    <div className="thumbnail" key={item.video_no}>
...
AppleToptenComponent.propTypes = {
  toptenList: PropTypes.array
};

export default AppleToptenComponent;
