...
const VideoLikeChartContainer = ({ userNo, category3No, lineChartWidth }) => {
    ...
    async function fetchData() {
      try {
        if (!isCancelled) {
          ...
          const result = await userApi.get(`/${userNo}/chart/videoLike`, {
            params: {
              period,
              category3No,
            },
...
VideoLikeChartContainer.propTypes = {
  userNo: PropTypes.number.isRequired,
  category3No: PropTypes.number,
};

export default VideoLikeChartContainer;
