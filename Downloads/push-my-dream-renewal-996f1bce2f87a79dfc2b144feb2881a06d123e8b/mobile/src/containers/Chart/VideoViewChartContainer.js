...
const VideoViewChartContainer = ({ userNo, category3No, lineChartWidth }) => {
    ...
    async function fetchData() {
      try {
        if (!isCancelled) {
          ...
          const result = await userApi.get(`/${userNo}/chart/videoView`, {
            params: {
              period,
              category3No,
            },
...
VideoViewChartContainer.propTypes = {
  userNo: PropTypes.number.isRequired,
  category3No: PropTypes.number,
};

export default VideoViewChartContainer;
